...
.input-container {
  display: flex;
  align-items: center;
  justify-content: center; /* Centering the input field */
  margin-bottom: 10px;
}

.input-field {
  width: 200px; /* Adjusting input width */
  margin-right: 10px; /* Adding space between input and button */
  padding: 10px;
  border: none;
  border-radius: 5px;
  font-size: 16px;
...
.add-button {
  padding: 10px 20px; /* Increasing padding for the button */
  border: none;
  border-radius: 5px;
  cursor: pointer;
  font-size: 16px;
